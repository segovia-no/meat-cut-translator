...
- **PWA Ready**: Manifest.json incluido para instalar como app

## 🚀 Demo

Visita: [https://traductordecortes.vercel.app](https://traductordecortes.vercel.app)

## 📦 Instalación

```bash
# Clonar el repositorio
git clone https://github.com/tu-usuario/meat-translator.git
...
Abre un PR o un issue.

---

Hecho con hambre para los amantes de la carne 🥩.
